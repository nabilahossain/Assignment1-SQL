...
My question:
Using the flights database, show the total number of flights the arrival (destination) airport have the first day of 
each month, ordered by greatest to least number of flights each month.
